...
PALLADIUMVERSION := v1.3
PALLADIUM_BUILD_VARIANT ?= VANILLA
PALLADIUM_BUILD_ZIP_TYPE := VANILLA
...
# MAIN
PALLADIUM_VERSION := PalladiumOS-$(PALLADIUMVERSION)-$(PALLADIUM_BUILD)-$(PALLADIUM_BUILD_DATE)-$(PALLADIUM_BUILDTYPE)-$(PALLADIUM_BUILD_ZIP_TYPE)
